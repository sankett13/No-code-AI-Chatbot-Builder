...
export default function HeroSection() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center text-center px-6 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
      ...
      >
        ...
        >
          Build Your Own{" "}
        <span className="text-[#141414]">AI Chatbot</span>
        </motion.h1>
        ...
        >
          Create intelligent chatbots by simply providing your business context. No coding, no complexity—just results.
        </motion.p>
